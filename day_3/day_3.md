...
`1` bits. Since the most common bit is `1`, the first bit of the gamma rate
is `1`.
...
multiplying the _oxygen generator_ rating by the _CO2 scrubber_ rating.
...
- Start with all 12 numbers and consider only the first bit of each number.
  ...
  in the first position: 11110, 10110, 10111, 10101, 11100, 10000, and
  11001.
